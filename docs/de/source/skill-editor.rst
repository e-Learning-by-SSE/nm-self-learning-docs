...
* Durch Anklicken des Stift-Icons wird der in der Tabelle fokussierte Skill in der linken Ansicht geöffnet und kann bearbeitet werden
* Durch Anklicken des Ordner-Icons wird dem in der Tabelle fokussierten Skill ein Kind-Skill hinzugefügt
* Durch Anklicken des Mülleimer-Icons wird der in der Tabelle fokussierte Skill gelöscht
...
* Mit dem Mauszeiger über einen Skill in der Tabelle hovern und das Ordner-Symbol anklicken
* Anklicken des Skill-Namens einen Skill aus der Tabelle auswählen und auf den Hinzufügen-Button klicken.
